				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price"><?php echo $price; ?><del class="product-old-price"><?php echo $row['Pro_Price']; ?></del></h3>
								<span class="product-available">In Stock</span>
							</div>
							<p><?php echo $row['Pro_Intro']; ?></p>
							</br></br>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
											<div class="datail"><p><?php echo $row['Pro_Detail']; ?></p></div>
